...
sim:
	...
	@cd $(simulator_path) && ./obj_dir/Vmycpu_top -perfdiff -uart -trace 1000000000 -perfonce -prog $(x)
...
# make way x=N
wav:
	# @cd $(simulator_path) && gtkwave --start=1us --end=1.1us trace-perf-$(x).fst debugFST.gtkw
